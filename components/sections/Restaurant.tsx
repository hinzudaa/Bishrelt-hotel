    ...
    icon: (
      ...
      >
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={1.5}
          d="M9 3v1m6-1v1M5 8h14M5 8a2 2 0 00-2 2v8a2 2 0 002 2h14a2 2 0 002-2v-8a2 2 0 00-2-2M8 13h.01M12 13h.01M16 13h.01"
        />
      </svg>
    ),
    title: "Дарсны зоорь",
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 h-auto md:h-[800px]">
        <div className="py-8 px-6 md:py-14 md:pr-20 md:pl-0 flex flex-col justify-center order-2 md:order-1">
          ...
          <p className="text-hotel-charcoal/65 text-sm leading-relaxed mb-10">
            ...
            мэдрээрэй. Шагнал хүртсэн тогооч нар зөвхөн улирлын чанартай хамгийн
            сайн орцуудыг ашиглан Монголын өв уламжлалыг орчин үеийн хоолтой
            хослуулан тансаг хоол хийдэг.
          </p>
          ...
          <ul className="space-y-6 mb-10">
            {features.map((f) => (
              <li key={f.title} className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-hotel-dark text-sm font-medium mb-0.5">
                    {f.title}
                  </p>
                  <p className="text-hotel-charcoal/55 text-xs leading-relaxed">
                    {f.desc}
                  </p>
                </div>
              </li>
