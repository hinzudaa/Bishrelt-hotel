...
const navLinks = [
  ...
  { label: "Embassy Restaurant", href: "#restaurant" },
  { label: "Grand Event Halls", href: "#events" },
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16 grid grid-cols-1 md:grid-cols-3 gap-12">
        <div>
          ...
          <p className="text-white/45 text-sm leading-relaxed max-w-xs">
            Монголын өв соёл дэлхийн жишигт нийцсэн тансаг хэрэглээнд нийцсэн газар. Айлчлал бүрт мартагдашгүй туршлага хүлээж байна.
          </p>
        </div>
