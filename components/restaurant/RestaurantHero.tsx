...
type Props = {
  dict: Dictionary["restaurantPage"]["hero"];
  lang: string;
};

export default function RestaurantHero({ dict, lang }: Props) {
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(10,10,10,0.70) 0%, rgba(10,10,10,0.25) 50%, rgba(10,10,10,0.85) 100%)",
        }}
      />
